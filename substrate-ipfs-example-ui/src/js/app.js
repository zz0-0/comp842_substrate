...
const uiElements = {
  fetchFileForm: document.getElementById("fetch-file-form"),
  metaDataInput: document.getElementById("meta-data-input"),
...
uiElements.metaDataInput.addEventListener("input", (event) => {
